Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/e41a493a0b408b24d8bada645079a57a"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				for (int glitterLayer = 0; glitterLayer < (2.0 /*_GlitterLayers*/); glitterLayer++)
				{
					...
					half3 glitterColor = poiThemeColor(poiMods, float4(0,1.480739,2,1).rgb, (0.0 /*_GlitterColorThemeIndex*/));
					...
					switch((0.0 /*_GlitterMode*/))
					{
						...
						if ((2.0 /*_GlitterSpeed*/) + glitterSpeedOffset > 0)
						{
							randomRotation = randomFloat3WiggleRange(randoPoint, (59.0 /*_GlitterAngleRange*/), (2.0 /*_GlitterSpeed*/), glitterSpeedOffset);
						}
						else
						{
						...
						finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(saturate(dot(lerp(glitterReflectionDirection, poiCam.viewDir, (0.011 /*_GlitterBias*/)), poiCam.viewDir)), (295.0 /*_GlitterContrast*/)), 0);
						finalGlitter *= glitterAlpha;
						break;
						case 1:
						float randomOffset = random(randoPoint);
						float brightness = (sin((_Time.x * 10 + randomOffset +glitterSpeedOffset) * (2.0 /*_GlitterSpeed*/)) * .5 + .5);
					...
					{
						glitterColor.rgb = hueShift(glitterColor.rgb, (0.477 /*_GlitterHueShift*/) + _Time.x * (0.0 /*_GlitterHueShiftSpeed*/));
					}
			...
			void applyPostProcessing(inout PoiFragData poiFragData, in PoiMesh poiMesh)
			{
				...
				col = GetContrast(col, (1.0 /*_PPContrast*/));
				col *= (1.0 /*_PPBrightness*/);
				col += (0.0 /*_PPLightness*/);
				float ppMask = 1;
				#if defined(PROP_PPMASK) || !defined(OPTIMIZER_ENABLED)
				ppMask = POI2D_SAMPLER_PAN(_PPMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_PPMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0))[(0.0 /*_PPMaskChannel*/)];
				ppMask = lerp(ppMask, 1 - ppMask, (0.0 /*_PPMaskInvert*/));
				col = lerp(poiFragData.finalColor, col, ppMask);
				#endif
				if ((1.0 /*_PPPosterization*/))
				{
					col = lerp(col, poiPosterize(col, (4.0 /*_PPPosterizationAmount*/)), ppMask);
				}
