...
Shader "ACiiL/toon/ACLS_Toon_AlphaTransparent_Outline" {
    CGINCLUDE
    ...
    Properties {
        ...
        // outline
        [ToggleUI] _useOutline("_useOutline",Int) = 1
        [ToggleUI] _fillOutlineDepth("_fillOutlineDepth",Int) = 0
        ...
        [ToggleUI] _Is_BlendBaseColor("_Is_BlendBaseColor", Int) = 0
        [ToggleUI] _Is_OutlineTex("_Is_OutlineTex", Int) = 0
        ...
        _Offset_Z("Offset Camera Z depth", Range(-0.05,0.05)) = 0
        [HDR] _outlineEmissionColor("_outlineEmissionColor",Color) = (0,0,0,1)
        _outlineEmissiveProportionalLum("_outlineEmissiveProportionalLum",Range(0,2) )= 0
        _outlineEmissionTint("_outlineEmissionTint",2D) = "white" {}
        [ToggleUI] _outlineEmissionUseMask("_outlineEmissionUseMask",Int) = 0
        _outlineEmissionMask("_outlineEmissionMask",2D) = "white" {}
        //// outline && alpha
        [ToggleUI] _seperateOutlineAlphaTweak("_seperateOutlineAlphaTweak", Int) = 0
        _Tweak_transparencyOutlines("_Tweak_transparencyOutlines",Range(-1,1) ) = 0
        ...
        //// outline
        [ToggleUI]_outlineEmissionColorAnimated("_outlineEmissionColorAnimated", Int) = 0
        //// Inventory 
